...
(function configureEvergage() {
    try {
       ...
       },{"allowBotTraffic":false,"corsAllowedOrigins":["*"],"defaultCurrency":"USD","defaultLocale":null,"disableQtipWindowScroll":false,"doNotStoreCookiesRequireProvidedAnonId":false,"doNotTrackPingRequestsForActions":false,"enableCorsRestrictedOrigins":false,"enableMessageRotation":false,"enableRememberMeUserIds":false,"enableTemplateEsc":false,"hideContentSections":false,"hideContentSectionsMillis":2500,"hidePagesForRedirect":false,"hidePagesForRedirectMillis":1000,"identityAttributes":["customerId","emailAddress","profileId","sfmcContactKey"],"lastModified":1660068062748,"preventSensitiveDataCapture":false,"rememberMeUserIdsMillis":63072000000,"secureCookie":false,"sendErrorEvents":true,"showPoweredBy":false,"siteConfigExecBeforePageReady":false,"spaRouteChangeTimeout":500,"trackAnonymousVisitors":true,"trackContextualRelatedItems":false,"trackSubdomainAsCompany":false,"trackUnknownPagesByTitle":false,"treatHashChangeAsPageLoad":false}       );
    } catch (e) {
          console.error(e);
    }
})();
...
/*jshint asi:true, funcscope:true, sub:true, scripturl: true, esversion: 6 */
/* globals WSI, pmc, SalesforceInteractions, Evergage */

const getCookieDomain = () => {
    var ckdom = SalesForceConnector.cookieDomain;
        if (window.location.href.indexOf("williams-sonoma.com") >= 0 ||
              window.location.href.indexOf("williams-sonoma.ca") >= 0 ) {
         ckdom.siteDomain = window.location.hostname.indexOf('.com') > 0 ? "williams-sonoma.com": "williams-sonoma.ca";
         ckdom.market = window.location.hostname.indexOf('.com') > 0 ? "ws" : "ws_ca";
        } else if (window.location.href.indexOf("westelm.com") >= 0||
             window.location.href.indexOf("westelm.ca") >= 0 ) {
         ckdom.siteDomain = window.location.hostname.indexOf('.com') > 0 ? "westelm.com": "westelm.ca";
         ckdom.market = window.location.hostname.indexOf('.com') > 0 ? "we" : "we_ca";
        } else if (window.location.href.indexOf("pbteen.com") >= 0||
             window.location.href.indexOf("pbteen.ca") >= 0 ) {
         ckdom.siteDomain = window.location.hostname.indexOf('.com') > 0 ? "pbteen.com": "pbteen.ca";
         ckdom.market = window.location.hostname.indexOf('.com') > 0 ? "pt" : "pt_ca";
        } else if (window.location.href.indexOf("potterybarnkids.com") >= 0||
             window.location.href.indexOf("potterybarnkids.ca") >= 0 ) {
         ckdom.siteDomain = window.location.hostname.indexOf('.com') > 0 ? "potterybarnkids.com": "potterybarnkids.ca";
         ckdom.market = window.location.hostname.indexOf('.com') > 0 ? "pk" : "pk_ca";
        } else if (window.location.href.indexOf("potterybarn.com") >= 0||
             window.location.href.indexOf("potterybarn.ca") >= 0 ) {
         ckdom.siteDomain = window.location.hostname.indexOf('.com') > 0 ? "potterybarn.com": "potterybarn.ca";
         ckdom.market = window.location.hostname.indexOf('.com') > 0 ? "pb" : "pb_ca";
        } else if (window.location.href.indexOf("markandgraham.com") >= 0||
             window.location.href.indexOf("markandgraham.ca") >= 0 ) {
         ckdom.siteDomain = window.location.hostname.indexOf('.com') > 0 ? "markandgraham.com": "markandgraham.ca";
         ckdom.market = window.location.hostname.indexOf('.com') > 0 ? "mg" : "mg_ca";
        }
};
...
SalesforceInteractions.init({    // Initializes the Interaction Studio Web SDK
    cookieDomain: SalesForceConnector.cookieDomain.siteDomain    // Optional tracking cookie domain configuration (overrides default)
}).then(() => {

    const sitemapConfig = {    // Sitemap configuration object
        global: {
            contentZones: [
                { name: "global_header_mfe", selector: ".global-promo__supernav.promo"},
                { name: "global_header_dp", selector: ".parsys_column.wsi-colctrl-lt2a-c0"},
                { name: "global_popup"},
                { name: "global_sitewide_banner_mfe", selector: ".ecm-content-slot.global-ticker-1"},
                { name: "global_mobile_nav_banner", selector:"#mobile-shop-nav-image-row"},
                { name: "my_recommendations_sitewide_banner", selector: "#swb-container"},
                { name: "search_recs_1", selector: ".grid-bottom-container > .wsi-recs-wrapper > div:nth-child(1)"},
                { name: "search_recs_2", selector: ".grid-bottom-container > .wsi-recs-wrapper > div:nth-child(2)"},
                  { name: "search_text_results", selector: "#typeAhead"},
            ],
            ...
            onActionEvent: (actionEvent) => {
                ...
                actionEvent.user.identities.hashedEmail = SalesForceConnector.pageData.hashedEmail;
                actionEvent.user.identities.adobeId = SalesForceConnector.pageData.adobeId;
                actionEvent.user.identities.businessLogin = SalesForceConnector.pageData.businessLogin;
                actionEvent.user.identities.zipCode = SalesForceConnector.pageData.zipCode;
        ...
        pageTypes: [
            {
                ...
                isMatch: () => SalesForceConnector.pageData.siteSection === 'home' || SalesForceConnector.pageData.siteSection === 'Home'
            },
            {
                ...
                isMatch: () => SalesForceConnector.pageData.pageName === 'williams-sonoma-home-landing' ||
                               window.location.pathname.split("/")[3] === 'williams-sonoma-home'
            },
            {
                ...
                isMatch: () => window.location.pathname.indexOf("/pages/baby-kids/") >= 0
                              || (window.location.pathname.indexOf("/shop/baby-kids/") >= 0 && SalesForceConnector.pageData.pageName === 'shop:baby-kids')
            },
            {
                ...
                isMatch: () => /\/pages\/business/.test(window.location.href) && window.location.hostname.indexOf("westelm") >= 0
            },
            {
                ...
                isMatch: () => /\/pages\/pbdorm/.test(window.location.href)
            },
            {
                ...
                isMatch: () => SalesForceConnector.pageData.pageName === 'baby homepage'
            },
            {
                name: "collaborations",
                interaction: {
                ...
                isMatch: () => SalesForceConnector.pageData.pageName.indexOf('shop:collaborations') >= 0
            },
            {
                name: "registry",
                interaction: {
                ...
                isMatch: () => /\/pages\/registry/.test(window.location.href) || SalesForceConnector.pageData.pageName === 'REGISTRY HOME' || SalesForceConnector.pageData.pageName === 'registry:registry-index' ||
                                SalesForceConnector.pageData.pageName === 'MANAGE REGISTRY' || SalesForceConnector.pageData.pageName === 'REGISTRY: MULTIPLE REGISTRIES'||
                                SalesForceConnector.pageData.pageName === 'REGISTRY: ACCOUNT SIGN IN CREATE' || SalesForceConnector.pageData.pageName === 'PAGES: Wedding Registry'
            },
            {
                name: "started_a_registry",
                interaction: {
                    name: "Started a Registry"
                },
                isMatch: () => SalesForceConnector.pageData.pageName === 'REGISTRY: CREATE'
            },
            {
                name: "completed_a_registry",
                interaction: {
                    name: "Completed a Registry"
                },
                isMatch: () => SalesForceConnector.pageData.pageName === 'MANAGE REGISTRY: CREATE'
            },
            {
                // each category page will be its own page type
                name: "category_" + window.location.pathname.split("/")[2] + "_" + window.location.pathname.split("/")[3],
                interaction: {
                    name: SalesforceInteractions.CatalogObjectInteractionName.ViewCatalogObject,
                    catalogObject: {
                        type: "Category",
                        id: SalesForceConnector.pageData.cat
                    }
                },
                   isMatch: () =>  (window.location.pathname.split("/")[1] === 'shop' || window.location.pathname.split("/")[2] === 'shop') && window.location.pathname.split("/")[2] !== 'collaborations'
                                   && window.location.pathname.split("/")[2] !== 'sale' && window.location.pathname.split("/")[2] !== 'baby-kids-sale'
                                   && window.location.pathname.split("/")[2] !== 'room-inspiration', // --> this should look up dd pageType for 'subcategory' and 'supercategory'

                   contentZones: [
                    { name: "supercat_top_1", selector: ".supercat-shop-wide-banner-below-bc-1"},
                    { name: "subcat_promo_1", selector: ".shop-wide-banner-1"},
                    { name: "cat_visual_facets", selector: ".visual-navigation"},
                ],
            },
            {
                ...
                interaction: {
                    ...
                    catalogObject: {
                        type: "Product",
                        id: () => {
                            return (SalesForceConnector.pageData.market) + "_" + SalesForceConnector.product.id || '';
                        },
                        attributes: {
                            price: SalesForceConnector.product.price,
                        },
                        relatedCatalogObjects: {
                            GroupVsSku: ["Group"],
                            Market: () => {
                                return [SalesForceConnector.pageData.market];
                            },
                            SubBrand: () => {
                                return [SalesForceConnector.product.brand];
                            },
                            Collaborator: () => {
                                return [SalesForceConnector.product.collaborator];
                            },
                        },
                    },
                },
                isMatch: () => SalesForceConnector.pageData.siteSection === 'products' && SalesForceConnector.pageData.pageType !== 'thin pip',

                contentZones: [
                    { name: "pip_recs_1", selector: ".product-pip > .wsi-recs-wrapper > div:nth-child(1)"},
                    { name: "pip_recs_2", selector: ".product-pip > .wsi-recs-wrapper > div:nth-child(2)"},
                    { name: "pip_recs_3", selector: ".product-pip > .wsi-recs-wrapper > div:nth-child(3)"},
                    { name: "pip_collection", selector: ".merch-recs-carousel-container"},
                    { name: "pip_related_products", selector: "#related-products"},
                    { name: "pip_stylistics", selector: "#stylitics-widget-container"},
                    { name: "pip_plcc", selector: ".plcc-rewards"},
                      { name: "pip_add_to_cart", selector: ".product-rac > .wsi-recs-wrapper"},
                ],
            },
            {
                name: "shopping_cart",
                interaction: {
                    ...
                    lineItems: SalesForceConnector.lineItems
                },
                isMatch: () => SalesForceConnector.pageData.siteSection === 'shoppingcart',

                contentZones: [
                    { name: "cart_recs_1", selector: ".product-recommendation.checkout-recommendations.machine-recs.you-may-also-like"},
                    { name: "cart_recs_2", selector: ".product-recommendation.rvi.machine-recs"},
                    { name: "cart_donation", selector: ".cart-donation"},
                ],
            },
            {
                name: "checkout",
                ...
                isMatch: () => /\/checkout\/app\/shipping/.test(window.location.href)
            },
            {
                name: "payment",
                interaction: {
                ...
                isMatch: () => /\/checkout\/app\/payment/.test(window.location.href)
            },
            {
                name: "purchase",
                interaction: {
                    ...
                    order: {
                        id: SalesForceConnector.pageData.orderId,
                        currency: SalesForceConnector.pageData.currency,
                        totalValue: SalesForceConnector.pageData.orderTotal,
                        lineItems: SalesForceConnector.order
                    }
                },
                isMatch: () => SalesForceConnector.pageData.orderId !== '',

                contentZones: [
                    { name: "order_recs_1", selector: ".product-recommendation.checkout-recommendations.order-complete.machine-recs.you-may-also-like"},
                ],
            },
            {
                name: "my_favorites",
                ...
                isMatch: () => SalesForceConnector.pageData.siteSection === 'favorites',
                contentZones: [
                    { name: "favorites-content-zone-top", selector: "#favorites-content-zone-top"},
                    { name: "favorites-content-zone-middle", selector: "#favorites-content-zone-middle"},
                    { name: "favorites-content-zone-bottom", selector: "#favorites-content-zone-bottom"},
                ],
            },
            {
                name: "appointments",
                ...
                isMatch: () => (window.location.pathname === '/appointments/' && window.location.search !== '') ||
                                (window.location.pathname.indexOf('appointments') >= 0 && window.location.pathname !== '/appointments/')
            },
            {
                name: "requestdesignconsult_start_appt_booking",
                interaction: {
            ...
            },
            {
                ...
                isMatch: () => SalesForceConnector.pageData.pageName === 'TP: MEMBER INFO' || SalesForceConnector.pageData.pageName === 'TP: SIGN IN'
            },
            {
                name: "design_studio",
                interaction: {
                ...
                isMatch: () => SalesForceConnector.pageData.pageName.indexOf('Design Crew') >= 0 || SalesForceConnector.pageData.pageName.indexOf('DESIGN SERVICES') >= 0
                                || /\/design-services/.test(window.location.href) || SalesForceConnector.pageData.pageName.indexOf('Style And Service') >= 0
            },
...
var SalesForceConnector = {
    ...
    logError: function(message) {
        ...
        if (pmc.environment.tealiumEnvironment !== "prod") {
            console.error(message);
        }
    },

    sendEventCartAdd: function(evt) {
        let lineItem = {};
        let items = evt.data.items.item;
        let item = {};
        for (let i = 0; i < items.length; i++) {
            item = items[i];
            lineItem = {
                catalogObjectType: "Product",
                catalogObjectId: (SalesForceConnector.pageData.market) + "_" + item.sku,
                price: item.price,
            ...
            SalesforceInteractions.sendEvent({
                interaction: {
                    ...
                    catalogObject: {
                        type: "Product",
                        id: (SalesForceConnector.pageData.market) + "_" + item.sku,
                        /*attributes: {
                            price: item.price
                        },*/
                        relatedCatalogObjects: {
                            GroupVsSku: ["Sku"],
                            Market: [SalesForceConnector.pageData.market],
                            SubBrand: [SalesForceConnector.product.brand],
                            Collaborator: [SalesForceConnector.product.collaborator]
                        }
                    }
                }
            });
    ...
    fireEvent: function(dd, evt) {
        var category = pmc.lowerCaseString(evt.category) || pmc.getNestedLowerCaseValue(evt, "data.category");
        var eventItem = pmc.lowerCaseString(evt.item);
        var item = "";

        if (eventItem !== "removefromcart") {
            if (evt.sku && evt.sku.length === 0) {
                item = eventItem;
            } else if (evt.sku && evt.sku.length > 0) {
                item = evt.sku[0];
            }
        }

        /*
        * Populate SalesForce SendEvent
        */
        if (category === 'qudini scheduling' && eventItem.indexOf('appointment choice') >= 0) {
            SalesforceInteractions.sendEvent({
                interaction: {
                    name: "RequestDesignConsult - Start Appointment Booking"
                }
        ...
        if (category === 'qudini scheduling' && (eventItem.indexOf('appointment confirmation') >= 0)) {
            SalesforceInteractions.sendEvent({
                interaction: {
        ...
        if (eventItem === 'removefromcart' && evt.eventName === 'cartEvent') {
            SalesforceInteractions.sendEvent({
                interaction: {
                    name: SalesforceInteractions.CartInteractionName.RemoveFromCart,
                    lineItem: {
                        catalogObjectId: (SalesForceConnector.pageData.market) + "_" + evt.SKU,
                        catalogObjectType: "Product",
                        price: parseFloat(evt.unitPrice),
                        quantity: parseInt(evt.quantity)
                    }
                }
            });
            return;
        ...
        if (category === 'checkout user flow') {
            if (evt.attributes.next === 'shipping') {
                SalesforceInteractions.sendEvent({
                    interaction: {
            ...
            if (evt.attributes.next === 'payment') {
                SalesforceInteractions.sendEvent({
                    interaction: {
        ...
        if (category === 'optimized registry creation' && SalesForceConnector.pageData.pageName === 'registry:registry-index'
        ...
        if ((category === 'optimized registry creation' && SalesForceConnector.pageData.pageName === 'registry:registry-index'
            && eventItem === 'confirmation') || window.location.search.indexOf('congrats') > 0) {
            SalesforceInteractions.sendEvent({
                interaction: {
                    name: "Completed a Registry"
                }
        ...
        if (category === 'minipip' && evt.groupId) {
            SalesforceInteractions.sendEvent({
                interaction: {
                    name: SalesforceInteractions.CatalogObjectInteractionName.QuickViewCatalogObject,
                    catalogObject: {
                        type: "Product",
                        id: (SalesForceConnector.pageData.market) + "_" + evt.groupId
                    }
                }
            });
        ...
        if (category === 'quick buy' && evt.productID) {
            SalesforceInteractions.sendEvent({
                interaction: {
                    name: SalesforceInteractions.CatalogObjectInteractionName.QuickViewCatalogObject,
                    catalogObject: {
                        type: "Product",
                        id: (SalesForceConnector.pageData.market) + "_" + evt.productID
                    }
                }
            });
        ...
        if (SalesForceConnector.pageData.pageName === "account:trade login") {
            if (category === "user authentication" && evt.item === "initiate") {
                SalesforceInteractions.sendEvent({
                    interaction: {
            ...
            if (category === "design trade" && evt.item === "merge accounts") {
                SalesforceInteractions.sendEvent({
                    interaction: {
                    ...
                    user: {
                        identities: {
                            designTradeMemberId: evt.designTradeMemberId,
                        },
                    },
                });
                return;
    ...
    firePageView(dd) {
        ...
        var pd = SalesForceConnector.pageData;
        var prodData = SalesForceConnector.product;
        pd.market = SalesForceConnector.cookieDomain.market;

        // page data to collect
        pd.siteSection = pmc.getNestedLowerCaseValue(dd, "page.pageCategory.primaryCategory");
        pd.pageName = pmc.getNestedLowerCaseValue(dd, "page.pageName");
        pd.pageType = pmc.getNestedLowerCaseValue(dd, "page.pageType");
        pd.architecture = pmc.getNestedLowerCaseValue(dd, "page.attributes.architecture");
        pd.cat = pmc.lowercaseArray(pmc.getNestedValue(dd, "page.pageCategory.categories")).join("|");
        pd.businessLogin = pmc.getNestedLowerCaseValue(dd, "page.attributes.designTradeMemberTier");
        pd.zipCode = pmc.getNestedLowerCaseValue(dd, "x_state.postalCode");

        // product catalog data to collect
        prodData.id = pmc.getNormalProdId(dd.product);
        prodData.brand = pmc.getNestedLowerCaseValue(dd, "page.attributes.concept");

        var categoriesArray = pmc.lowercaseArray(pmc.getNestedValue(dd, "product.productCategory.categories")) || [];
        if (categoriesArray[0] === "collaborations") {
            prodData.collaborator = categoriesArray[categoriesArray.length - 1];
        }

        var regularPrice = pmc.getNestedLowerCaseValue(dd, "product.price.regular.min");
        var sellPrice = pmc.getNestedLowerCaseValue(dd, "product.price.selling.min");

        if ((regularPrice === sellPrice) || (regularPrice === undefined && sellPrice !== undefined) ) {
            prodData.price = 100;
        }
        else {
            prodData.price = 50;
        ...
        // user IDs
        if (window.utag_data && window.utag_data.wsid_svi3) {
            pd.adobeId = window.utag_data.wsid_svi3;
        }
        if (window.utag_data && window.utag_data.pmc_eVar143) {
            pd.hashedEmail = window.utag_data.pmc_eVar143;
        }

        // for ReplaceCart action
        if (window.location.pathname.indexOf('/shoppingcart/') >= 0) {
            var sf_cart_id = "", sf_cart_price = "", sf_cart_quantity = "";
            var sf_lineItems = SalesForceConnector.lineItems;

            if (dd.x_cart && dd.x_cart.orders) {
                var dd_cart = dd.x_cart.orders[0].items;
                for (let i=0; i < dd_cart.length; i++) {

                    if (dd_cart[i].productID && dd_cart[i].productID.sku) {
                        sf_cart_id = (SalesForceConnector.pageData.market) + "_" + dd_cart[i].productID.sku;
                    }

                    if (dd_cart[i].price && dd_cart[i].price.unitPrice) {
                        sf_cart_price = dd_cart[i].price.unitPrice;
                    }

                    if (dd_cart[i].quantity) {
                        sf_cart_quantity = dd_cart[i].quantity;
                    }

                    const lineItem = {
                        catalogObjectType: "Product",
                        catalogObjectId: sf_cart_id,
                        price: sf_cart_price,
                        quantity: sf_cart_quantity
                    };

                    sf_lineItems.push(lineItem);
                }
            }
        }

        // for Purchase action
        if (dd.x_transaction && dd.x_transaction.orders && dd.x_transaction.orders[0] && dd.x_transaction.orders[0].orderID) {

            var sf_purchase_cart_id = "", sf_purchase_cart_price = "", sf_purchase_cart_quantity = "";
            var dd_purchase_cart = [];
            var sf_purchase_lineItems = SalesForceConnector.order;

            if (dd.x_cart && dd.x_cart.orders && dd.x_cart.orders[0] && dd.x_cart.orders[0].items) {
                dd_purchase_cart = dd.x_cart.orders[0].items;
            }
            else if (dd.x_transaction && dd.x_transaction.orders && dd.x_transaction.orders[0] && dd.x_transaction.orders[0].items) {
                dd_purchase_cart = dd.x_transaction.orders[0].items;
            }

            for (let i=0; i < dd_purchase_cart.length; i++) {

                if (dd_purchase_cart[i].productID && dd_purchase_cart[i].productID.sku) {
                    sf_purchase_cart_id = (SalesForceConnector.pageData.market) + "_" + dd_purchase_cart[i].productID.sku;
                }

                if (dd_purchase_cart[i].price && dd_purchase_cart[i].price.unitPrice) {
                    sf_purchase_cart_price = dd_purchase_cart[i].price.unitPrice;
                }

                if (dd_purchase_cart[i].quantity) {
                    sf_purchase_cart_quantity = dd_purchase_cart[i].quantity;
                }

                const lineItem = {
                    catalogObjectType: "Product",
                    catalogObjectId: sf_purchase_cart_id,
                    price: sf_purchase_cart_price,
                    quantity: sf_purchase_cart_quantity
                };

                sf_purchase_lineItems.push(lineItem);
            }

            if (dd.x_transaction && dd.x_transaction.orders && dd.x_transaction.orders[0].orderID) {
                pd.orderId = dd.x_transaction.orders[0].orderID;
            }

            if (dd.x_transaction && dd.x_transaction.orders && dd.x_transaction.orders[0].price && dd.x_transaction.orders[0].price.orderTotal) {
                pd.orderTotal = dd.x_transaction.orders[0].price.orderTotal;
            }
    ...
    startListener: function() {
        WSI.dataLayer.registerCallback(function(digitalData, eventData) {
            var dd = digitalData || window.digitalData;

            if (!eventData.name && eventData.category) {
                SalesForceConnector.fireEvent(dd, eventData);
            } else if (eventData.name === "dataLayerReady") {
                SalesForceConnector.firePageView(dd);
                fireISSitemap();
            } else if (eventData.name === "addToCart") {
                SalesForceConnector.sendEventCartAdd(eventData);
            } else if (eventData.name === "addToRegistry") {
                SalesForceConnector.fireEvent(dd, eventData);
            } else if (eventData.data) {
                var data = eventData.data.data || eventData.data;
                SalesForceConnector.fireEvent(dd, data);
            }
        });
    },
...
SalesForceConnector.startListener();
} catch (e) {
    if (typeof window.Evergage === "object" && typeof window.Evergage.getVersion === "function" && window.Evergage.getVersion() >= 5) {
